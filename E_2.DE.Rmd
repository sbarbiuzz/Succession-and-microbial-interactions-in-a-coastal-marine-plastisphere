...
e.f <- readRDS('Scripts/euk.otu.rds')
b.f <- readRDS('Scripts/bact.otu.rds')
be <- readRDS('Scripts/be.phylo_names.rds')
...
be.ps <- phyloseq(otu_table(e.f, taxa_are_rows = F),
                  sample_data(be))
...
#pdf('Scripts/Eukaryotes/Res/E_DE/PPP_timeseries.pdf',height = 20, width = 10)
Heatmap(otu.ordered,
...
ASVS <- c('E_G.Cymbella.2', 'E_S.Bugula_plumosa.1', 'B_G.Dolichospermum.8',
          'B_G.Flavimaricola.17', 'E_O.Corallinales.4', 
          'E_S.Haplopoma_graniferum.12', 'E_S.Microporella_ciliata.3', 
          "E_G.Ephelota.6", "E_S.Hydroides_sanctaecrucis.14", 
          "E_G.Stentor.16", "E_S.Crisia_aculeata.5")
...
#pdf('Scripts/Eukaryotes/Res/E_DE/HDP_timeseries.pdf',height = 20, width = 10)
Heatmap(otu.ordered,
        column_order = colnames(otu.ordered),
        cluster_rows = F,
...
#pdf('Scripts/Eukaryotes/Res/E_DE/PSY_timeseries.pdf',height = 20, width = 10)
Heatmap(otu.ordered,
        column_order = colnames(otu.ordered),
        cluster_rows = F,
...
#pdf('Scripts/Eukaryotes/Res/E_DE/G_timeseries.pdf',height = 20, width = 10)
Heatmap(otu.ordered,
        column_order = colnames(otu.ordered),
        cluster_rows = F,
        column_title = 'Glass') 
...
#ggsave('Scripts/Eukaryotes/Res/E_DE/summer_vs_fall.pdf', height = 7, width = 14)
```
